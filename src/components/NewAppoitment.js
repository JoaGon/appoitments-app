...
const NewAppoitment = (props) => {

    // Generar state como objeto
    const [appoitment, saveAppoiment] = useState({
        nombre: '',
        propietario: '',
        fecha: '',
        hora: '',
    ...
    const createNewAppoitment = e => {
        e.preventDefault();

        // enviar la petición por axios
        clienteAxios.post('/patients', appoitment)
            .then(resp => {
...
export default withRouter(NewAppoitment);